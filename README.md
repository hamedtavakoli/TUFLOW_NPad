...
TUFLOW Command Studio (TCS) is a browser-based editor for TUFLOW control files.
...
- Project file browser with folder and TUFLOW type views.
...
- `src/lib/projectFiles.ts` - project indexing and readable text file rules.
- `src/lib/projectFileBrowser.ts` - file browser filtering/grouping.
