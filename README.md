...
- Static in-app help page that explains the workspace, common workflow, diagnostics, Project Root setup, and troubleshooting tips.
...
7. Open **Help** from the toolbar when you need a quick guide or troubleshooting checklist.
...
- `public/help.html` - static user help page served with the app.
